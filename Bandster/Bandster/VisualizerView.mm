...
- (id)initWithFrame:(CGRect)frame
{
  ...
  if (self) {
    ...
    //cell.color = [[UIColor colorWithRed:1.0f green:0.53f blue:0.0f alpha:0.8f] CGColor];
      cell.color = [[UIColor colorWithRed:41/255.0 green:242/255.0 blue:60/255.0 alpha:0.8f] CGColor];
    /*
    cell.redRange = 0.46f;
     ...
     */
    cell.redRange = 41/255.0;
    cell.greenRange = 242/255.0;
    cell.blueRange = 60/255.0;
    cell.alphaRange = 0.55f;
...
- (void)setRed {
    ...
    cell.color = [[UIColor colorWithRed:244/255.0 green:41/255.0 blue:108/255.0 alpha:0.8f] CGColor];
...
- (void)setGreen {
    ...
    CAEmitterCell *cell = [emitterLayer.emitterCells objectAtIndex:0];
    cell.color = [[UIColor colorWithRed:41/255.0 green:244/255.0 blue:79/255.0 alpha:0.8f] CGColor];
